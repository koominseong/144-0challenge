# dynasty_growth.py
# =========================================
# KBO Dynasty - 오프시즌 성장 / 노쇠 / 은퇴 (일괄 upsert 버전)
# DB 호출: 조회 2회 + upsert 분할 + 은퇴 로스터 삭제
# 사전 준비: ALTER TABLE dynasty_player ALTER COLUMN id SET GENERATED BY DEFAULT;
# =========================================
